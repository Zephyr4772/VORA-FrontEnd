...
import { User, Server, Download, Trash2, ChevronLeft, Save, LogOut, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
...
export default function SettingsPage({
  ...
  userSession, messages, setMessages
}: SettingsPageProps) {
            ...
            <div className="max-w-3xl space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-300">
              ...
              {localProvider === 'ollama' && (
                <div className="space-y-4 bg-gray-50 p-6 rounded-2xl border border-gray-100">
                  ...
                  <p className="text-xs text-gray-500">Ensure Ollama is running (`ollama serve`) on localhost:11434.</p>
                </div>
              )}
